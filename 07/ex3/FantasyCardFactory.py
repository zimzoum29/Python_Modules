...
from ex0 import CardRarity, CardType, SpellEffect
...
class FantasyCardFactory(CardFactory):
    ...
    def create_creature(self):
        ...
        return CreatureCard(name, cost, CardRarity.COMMON, attack, health)

    def create_spell(self):
        spells = [
            ("Lightning Bolt", 3, SpellEffect.DAMAGE),
            ("Healing Light", 2, SpellEffect.HEAL)
        ]
        name, cost, effect = random.choice(spells)
        return SpellCard(name, cost, CardRarity.RARE, effect)
    ...
    def create_artifact(self):
        ...
        return ArtifactCard(
            name, cost, CardRarity.EPIC, durability, effect)
